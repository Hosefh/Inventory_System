                ...
                <table id="example" class="table table-hover data-table" style="width: 100%">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-row">
                                ...
                                <div class="col-md-12 mb-2">
                                  ...
                                  <input type="number" class="form-control" id="validationCustom01" name="barcode"
                                    value="<?php echo $barresult['barcode']; ?>" required>
                                ...
                                <div class="form-row">
                                  <div class="col-md-12 mb-2">
                                    <label for="validationCustom01">Supply ID</label>
                                    <input type="number" class="form-control" id="validationCustom01" name="supplyid"
                                      placeholder="Enter Supply ID" required>
                                    <div class="valid-feedback">
                                      Looks good!
                                    </div>
                                  </div>
                                  <div class="form-row">
                                    <div class="col-md-12 mb-2">
                                      <label for="validationCustom01">Borrower ID</label>
                                      <input type="number" class="form-control" id="validationCustom01"
                                        name="borrowerid" placeholder="Enter Borrower ID" required>
                                      <div class="valid-feedback">
                                        Looks good!
                                      </div>
                                    </div>
                            ...
                            if (isset($_POST['borrowerid'])) {
                              $sql = "SELECT * FROM supplies s where s.id = '" . $_POST['supplyid'] . "' and s.quantity-s.borrowed_quantity >= '" . $_POST['quantity'] . "';";
                              $result = mysqli_query($conn, $sql);

                              if (mysqli_num_rows($result) === 1) {
                                $sql1 = "SELECT * FROM employees e where e.employee_id='" . $_POST['borrowerid'] . "';";
                                $result1 = mysqli_query($conn, $sql1);
                                if (mysqli_num_rows($result1) === 1) {
                                  $sql2 = "INSERT INTO `transactions` (barcode,`quantity`,date_released,`borrower_id`,supply_id)
                                                VALUES('" . $_POST['barcode'] . "','" . $_POST['quantity'] . "',NOW(),'" . $_POST['borrowerid'] . "','" . $_POST['supplyid'] . "')";

                                  if ($conn->query($sql2) === TRUE) {
                                    $sql3 = "UPDATE supplies SET borrowed_quantity = borrowed_quantity+" . $_POST['quantity'] . ",transdate = NOW() WHERE id = '" . $_POST['supplyid'] . "';";
                                    $conn->query($sql3);
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $result['borrower_id']; ?>
                      </td>
                      <td>
                        <?php echo $result['supply_id']; ?>
                      </td>
                      <td>
